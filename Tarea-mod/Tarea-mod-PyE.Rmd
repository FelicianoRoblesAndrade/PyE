...
# Simbologia
legend("topright", legend = c(paste0("Evento 1, q = ",q1),paste0("Evento 2, q = ",q2),paste0("Evento 3, ",q3a," > q > ",q3b)),lwd = 3, col = c("red","purple","cyan"))
...
# Simbologia
legend("topleft", legend = c(paste0("Evento 1, q = ",q1),paste0("Evento 2, q = ",q2),paste0("Evento 3, ",q3a," > q > ",q3b)),lwd = 3, col = c("red","purple","cyan"))
